...
for (iter in 2:S) {
  ...
  beta_star <- rnorm(k, beta_mat_init1[iter-1,], 1)
...
acc <- 0
for(iter in 2:S){
  beta_star <- rnorm(k, beta_mat_init2[iter-1,], 1)
  newpost = lpost.LR(beta_star, X, y)
...
acc <- 0
for(iter in 2:S){
  beta_star <- rnorm(k,beta_mat_init3[iter-1,], 1)
  newpost=lpost.LR(beta_star,X,y)
...
acc <- 0
for(iter in 2:S){
  beta_star <- rnorm(k,beta_mat_init4[iter-1,], 1)
  newpost=lpost.LR(beta_star,X,y)
