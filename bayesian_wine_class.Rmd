...
plot(beta_mat_init1[,2], type="l", col="magenta", ylim=(c(-30, 50)), ylab=expression(beta[1]))
...
plot(beta_mat_init1[,7], type="l", col="magenta", ylim=(c(-30, 30)), main=expression(beta[6]))
...
plot(beta_mat_init1[,8], type="l", col="magenta", ylim=(c(-30, 40)), main=expression(beta[7]))
...
plot(beta_mat_init1[,12], type="l", col="magenta", ylim=(c(-30, 50)), main=expression(beta[11]))
