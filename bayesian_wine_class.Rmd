...
## Likelihood.
The likelihood function for the logistic regression model is defined as the product of binomial likelihoods with the probability of success, p, being the log-odds.
